...
# file_path = './quote_collection.txt'
...
# new_sentence = 'Como afirma João Costa, in A Responsabilidade Civil do Médico-Reflexões Sobre a Noção da Perda de Chance e a Tutela do Doente Lesado, 2008, Coimbra Editora pp. 93-96, destaca que, em geral, se o objetivo almejado for alcançado'
new_sentence = '(Fabio Nogueira, Identificação de referencias, vol. 1, pag. 196)'
